package me.klouse.kauctionhouse.command;

import me.klouse.kauctionhouse.KAuctionHouse;
import me.klouse.kauctionhouse.gui.AuctionGUI;
...
public final class AuctionCommand implements CommandExecutor, TabCompleter {
    ...
    public AuctionCommand(KAuctionHouse plugin, AuctionService auctionService, ClaimService claimService, ExpiredService expiredService) {
        this.plugin = plugin;
    ...
    private void handleReload(Player player) {
        if (!player.hasPermission("klouse.auction.reload")) {
